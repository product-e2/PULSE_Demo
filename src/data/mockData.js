...
// ── Intelligence Panel Scripts (tenant-aware factory) ─────
export function getIntelScripts(tenant) {
  const urlPrefix = tenant.intel.urlPrefix
  ...
  return {
    ...
    act2_scan: [
      ...
      { text: `  URL: ${urlPrefix}/bundesliga/bayern-dortmund-preview`, color: 'blue', delay: 300 },
